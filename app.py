...
from page.doctor import doctor_detail, get_doctor_detail, del_doctor_detail, update_doctor_detail
        ...
        if selected == 'Home':
            ...
            with st.sidebar:
                selected = option_menu(
                    ...
                    icons=['person', 'snow2', 'trash', 'card-list'],
                    menu_icon='cast',
                    default_index=0,
            ...
            if selected == 'Register':
                ...
                if doctor_btn:
                    single_doc = get_doctor_detail(doctor_name)
                    st.table(single_doc)
